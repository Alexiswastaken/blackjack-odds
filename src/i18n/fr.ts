...
export const fr = {
  ...
  'decision.recommended.win': '{percent} de chances de gagner',
  ...
  'multi.split': 'Splitter',
  'multi.seatHelp': 'Chaque joueur peut splitter sa paire : ses deux mains sont alors suivies séparément.',
