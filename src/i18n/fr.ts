...
export const fr = {
  ...
  'decision.dealer.title': 'Carte visible du croupier',
  'decision.dealer.help.empty': 'Une seule carte : celle qui est retournée.',
  'decision.dealer.help.set': 'Annulez la dernière carte pour la corriger.',
  'decision.dealer.value': 'Croupier : {card}',
  'decision.hand.title': 'Ma main',
  'decision.hand.help':
    'Chaque carte cliquée sort du sabot partagé, y compris celles que vous piochez.',
  'decision.soft': '(soft)',
  'decision.splitBadge': 'main splittée',
  'decision.nextHand': 'Main suivante',
  'decision.playSplit': 'Jouer la main splittée',
  'decision.notSplit': "Ce n'est pas une main splittée",
  ...
  'decision.incomplete':
    'Renseignez au moins deux cartes en main et la carte visible du croupier pour lancer le calcul.',
